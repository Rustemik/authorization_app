...
abstract class AppLocalizations {
  ...
  /// No description provided for @titleHello.
  ///
  /// In en, this message translates to:
  /// **'Hello'**
  String get titleHello;
  ...
  /// No description provided for @titlePassword.
  ///
  /// In en, this message translates to:
  /// **'Password'**
  String get titlePassword;

  /// No description provided for @titleIncorrect.
  ///
  /// In en, this message translates to:
  /// **'Incorrect login or password'**
  String get titleIncorrect;
  ...
  /// No description provided for @titleLogoutButton.
  ///
  /// In en, this message translates to:
  /// **'Logout'**
  String get titleLogoutButton;
}
